...
Parses app source code to extract references to workflows, forms, and data providers.
Used by:
...
def parse_dependencies(source: str) -> list[tuple[str, UUID]]:
    """
    Parse source code and extract entity dependencies.

    Scans for patterns like useWorkflow('uuid'), useForm('uuid'), etc.
    ...
    Returns:
        List of (type, uuid) tuples. Types are: "workflow", "form", "data_provider"
    """
