...
import type { SelectComponentProps, SelectOption } from "@/lib/app-builder-types";
...
export function SelectComponent({
	...
	const options: SelectOption[] = useMemo(() => {
		...
		return [];
	}, [props.options, props.optionsSource, props.valueField, props.labelField, context.data]);
